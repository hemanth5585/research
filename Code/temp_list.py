...
path_of_excel = "C:/Users/chhem/OneDrive/Desktop/Project/FY/Dataset/Dataset.xlsx"
path_of_excel1 = "C:/Users/chhem/OneDrive/Desktop/Project/FY/Dataset/output.xlsx"
def function():
    i = 1
    while i < len(head):
        print(i)
            ...
            if check[i]==False:
                ...
                for tag in soup.select('p a'):
                    try:
                        ...
                        print("Something went wrong don't mind")
...
first_url ="/wiki/Software_development"
...
#first - all main headings
#head  - all sub topics of all links
function()
print(len(head))
print(first)